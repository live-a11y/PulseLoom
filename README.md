...
* Track-based sequencing with multiple lanes and targets
* Automation-style curves for smooth parameter changes
* Per-track OSC routing, including target host, port, and OSC address
* MIDI input control for external controllers
* Session save/load for repeatable setups
* Designed for experimental music, modular/interactive systems, and custom audio workflows
